...
import com.example.umaiuniverse.databinding.ActivityPaginaPrincipalBinding;
...
private ActivityPaginaPrincipalBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(binding.getRoot());
        ...
        binding.appBarPaginaPrincipal.fab.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.pagina__principal, menu);
        return true;
    }
